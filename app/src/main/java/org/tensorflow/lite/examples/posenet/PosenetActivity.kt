...
class PosenetActivity :
  ...
  override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
    ...
    database = FirebaseDatabase
      .getInstance("https://ziksi-ff871.firebaseio.com/")
      .reference

//    database.setValue("Hello time series")
  }

  @RequiresApi(Build.VERSION_CODES.O)
  fun saveTimeSeriesData(person: Person){

    if (person.score > 0.5) {
      val time = System.currentTimeMillis().toInt()
      val ts: String = time.toString()
      database.child("data")
        .child("uuid")
        .setValue(person)

      database.child("timeseriesdata")
        .child(ts)
        .setValue(person)
    }
